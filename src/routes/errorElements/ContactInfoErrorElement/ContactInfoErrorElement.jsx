...
const ContactInfoErrorElementComponent = styled.div`
	display: flex;
...
export function ContactInfoErrorElement({ theme }) {
	const error = useRouteError();
	return (
		<ContactInfoErrorElementComponent theme={theme}>
			<StyledDiv>
		...
		</ContactInfoErrorElementComponent>
	);
}
